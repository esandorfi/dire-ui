        ...
        <div class="mb-8">
          ...
          <UCard>
            <div class="hierarchy-list">
              <div
                v-for="(children, parent) in typeHierarchy"
                :key="parent"
                class="hierarchy-item mb-4"
              >
          ...
          <div v-for="level in maxLevel" :key="`level-${level}`" class="mb-6">
            ...
            <UCard>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                  v-for="typeInfo in getTypesByLevel(level)"
                  :key="typeInfo.path"
                  class="type-info-item p-2 border rounded"
                >
                  <div class="flex justify-between items-center">
                    <UBadge color="primary">{{ typeInfo.type }}</UBadge>
                    <span
                      v-if="typeInfo.hasChildren"
...
import type { AstTypeInfo } from "../domains/catalogue/composables/useAstTypes";
